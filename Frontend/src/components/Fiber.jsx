...
const Fiber = () => {
  return (
    <div className="w-full h-screen relative  flex">
      <div className="absolute left-[43vw] top-32  w-36 p-1 py-2 rounded-md bg-[#03E9F4] text-center text-black font-bold text-sm">
        WHY CHOOSE US
      </div>
      <p className="absolute left-[27vw] top-48 text-black text-3xl font-bold ">
      ...
      >
        ...
        <div className="p-6">
          <h5 className="mb-2 w-60 ml-6  text-xl leading-tight text-black font-bold">
      ...
      >
        ...
        <div className="p-6">
          <h5 className="mb-2 w-80 ml-14 text-xl leading-tight text-black font-bold">
            Parental Control
          </h5>
          <h5 className="mb-2 ml-16 w-80 text-xl leading-tight text-black font-bold">
            & Safety Kids
          </h5>
